...
public class CompositionGeneratorHttp extends AbstractHttpHelper implements HttpFunction {
  ...
  public void service(final HttpRequest request, final HttpResponse response) throws Exception {
    ...
    if(contentType.equals("application/json")){
      ...
      if (!body.isEmpty()) {
        players = List.of(AbstractHttpHelper.MAPPER.readValue(body, Player[].class));
      }
      ...
      AbstractHttpHelper.MAPPER.writeValue(response.getWriter(), generator.getNBestCompositions(players));
    }
  }
